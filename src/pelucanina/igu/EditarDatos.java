...
int numCliente;
     ...
     */
public EditarDatos(int idMascota, String nombreMascota, String raza, String color, String alergico, String atencionEspecial, String observaciones, String nombreDuenio, String celDuenio) {
    initComponents();
    this.numCliente = idMascota;
    control = new Controladora();

    // Inicializar los campos del formulario con los datos proporcionados
    txtNombre.setText(nombreMascota);
    txtRaza.setText(raza);
    txtColor.setText(color);
    txtObservaciones.setText(observaciones);
    cmbAlergico.setSelectedItem(alergico);
    cmbAtencionEspecial.setSelectedItem(atencionEspecial);
    txtNameDueño.setText(nombreDuenio);
    txtCelDueño.setText(celDuenio);
}
    ...
    // Llamar a la Controladora para actualizar la mascota
    try {
        control.actualizarMascota(numCliente, nombreMascota, raza, color, alergico, atencionEspecial, observaciones, nombreDuenio, celDuenio);
    ...
    private void btnRegresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegresarActionPerformed
        ...
        MostrarDatos principalWindow = new MostrarDatos();
